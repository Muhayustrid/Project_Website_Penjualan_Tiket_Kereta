    ...
    <div class="main-content container mt-5 pt-5">
        <div class="card">
            <div class="card-body">
                ...
                <p>Berikut adalah daftar stasiun:</p>

                <a href="create_stasiun.php" class="btn btn-primary">Create New</a>

                <div class="table-responsive">
                    <table class="table table-bordered" id="stasiun-table">
                        ...
                        <tbody id="stasiun-tbody">
                            <?php
                            $query = "SELECT * FROM stasiun";
                            $result = mysqli_query($conn, $query);

                            while ($row = mysqli_fetch_assoc($result)) {
                                echo '<tr data-id="' . $row['id_stasiun'] . '">';
                                echo '<td>' . $row['id_stasiun'] . '</td>';
                                echo '<td>' . $row['nama_stasiun'] . '</td>';
                                echo '<td>' . $row['alamat_stasiun'] . '</td>';
                                echo '<td>
                                        <a href="edit_stasiun.php?id_stasiun=' . $row['id_stasiun'] . '" class="btn btn-primary">Edit</a>
                                        <a href="delete_stasiun.php?id_stasiun=' . $row['id_stasiun'] . '" class="btn btn-danger">Delete</a>
                                      </td>';
                                echo '</tr>';
                            }
