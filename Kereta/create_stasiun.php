...
if (isset($_POST['submit'])) {
    ...
    $lokasi = $_POST['alamat_stasiun'];

    $query = "INSERT INTO stasiun (id_stasiun, nama_stasiun, alamat_stasiun) VALUES ('$id_stasiun', '$nama_stasiun', '$lokasi')";
...
<body style="background-color: #EEEEEE;">
    ...
    <div class="main-content container mt-5 pt-5">
        <div class="card">
            <div class="card-body">
                <h2>Create Stasiun</h2>
                <p>Isi form di bawah ini untuk membuat stasiun baru:</p>

                <form action="" method="post">
                    <label for="id_stasiun">ID Stasiun:</label>
                    <input type="text" id="id_stasiun" name="id_stasiun" class="form-control"><br><br>

                    <label for="nama_stasiun">Nama Stasiun:</label>
                    <input type="text" id="nama_stasiun" name="nama_stasiun" class="form-control"><br><br>
                    
                    <label for="alamat_stasiun">Lokasi:</label>
                    <input type="text" id="alamat_stasiun" name="alamat_stasiun" class="form-control"><br><br>
