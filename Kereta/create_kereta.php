...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO kereta_api (nama_kereta, rute, biaya, total_kursi) VALUES ('$nama_kereta', '$rute', '$biaya', '$total_kursi')";
...
<body style="background-color: #EEEEEE;">
    ...
    <div class="main-content container mt-5 pt-5">
        <div class="card">
            <div class="card-body">
                <h2>Create Kereta</h2>
                <p>Isi form di bawah ini untuk membuat kereta baru:</p>

                <form action="" method="post">
                    <label for="nama_kereta">Nama Kereta:</label>
                    <input type="text" id="nama_kereta" name="nama_kereta" class="form-control"><br><br>
                    
                    <label for="rute">Rute:</label>
                    <input type="text" id="rute" name="rute" class="form-control"><br><br>

                    <label for="biaya">Biaya:</label>
                    <input type="text" id="biaya" name="biaya" class="form-control"><br><br>

                    <label for="total_kursi">Total Kursi:</label>
                    <input type="number" id="total_kursi" name="total_kursi" class="form-control"><br><br>
